...
public:
    JBlock()
    {
        ...
        cells[2] = {Position(0, 1), Position(1, 1), Position(2,0), Position(2,1)};
...
TBlock()
    {
        ...
        cells[2] = {Position(0, 1), Position(1, 0), Position(1,1), Position(2,1)};
...
ZBlock()
    {
        ...
        cells[2] = {Position(0, 1), Position(1, 0), Position(1,1), Position(2,0)};
